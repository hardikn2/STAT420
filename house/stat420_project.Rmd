...
house_data_numeric = house_data_raw[ , !(names(house_data_raw) %in% remove)]
...
model_interactive = lm(price ~ (bedrooms + sqft_living + floors + waterfront + 
    view + condition + grade + yr_built + yr_renovated + lat + 
    long + sqft_living15 + sqft_lot15)^2 ,data = house_trn)
