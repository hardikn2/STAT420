...
While Adjusted $R^2$ `r summary(model_int_bic)$adj.r.squared` increases not considerably, the $RMSE_{test}$ `r calc_test_rmse(model_int_bic, log=TRUE)` decreases which shows that our model is **overfitting**. Also the QQ-plot exhibits a violation of normality. We remove influential data in an attempt to improve normality and test it.
